        ...
        >
            ...
            >
                ...
                <input
                    ...
                    accept="image/*"
                    capture="environment"
                    onchange="GGIrregularity.Media.previewPhoto(this)"
                    style="
                        position:absolute;
                        width:1px;
                        height:1px;
                ...
                <input
                    ...
                    accept="video/*"
                    capture="environment"
                    onchange="GGIrregularity.Media.previewVideo(this)"
                    style="
                        position:absolute;
                        width:1px;
                        height:1px;
                ...
                <input
                    ...
                    type="file"
                    accept="audio/*"
                    onchange="GGIrregularity.Media.previewAudio(this)"
                    style="
                        position:absolute;
                        width:1px;
                        height:1px;
            ...
            >
                ...
                <button
                    type="button"
                    onclick="ggIrregularityChangePhoto()"
                    style="
                        flex:1;
                        min-height:34px;
                        border:1px solid #c8d6c8;
                ...
                <button
                    type="button"
                    onclick="ggIrregularityRemovePhoto()"
                    style="
                        flex:1;
                        min-height:34px;
            ...
            >
                ...
                <button
                    type="button"
                    onclick="ggIrregularityChangeVideo()"
                    style="
                        flex:1;
                        min-height:34px;
                        border:1px solid #c8d6c8;
                ...
                <button
                    type="button"
                    onclick="ggIrregularityRemoveVideo()"
                    style="
                        flex:1;
                        min-height:34px;
                        border:1px solid #e0b0b0;
            ...
            >
                ...
                <button
                    type="button"
                    onclick="ggIrregularityRecordAgain()"
                    style="
                        flex:1;
                        min-height:34px;
                        border:1px solid #c8d6c8;
                ...
                <button
                    type="button"
                    onclick="ggIrregularityRemoveAudio()"
                    style="
                        flex:1;
                        min-height:34px;
                        border:1px solid #e0b0b0;
            ...
            >
                ...
                <button
                    ...
                    type="button"
                    onclick="ggIrregularityRecordAudio()"
                    style="
                        flex:1;
                        min-height:36px;
                        border:1px solid #c8d6c8;
                ...
                <button
                    ...
                    type="button"
                    onclick="ggIrregularitySelectAudio()"
                    style="
                        flex:1;
                        min-height:36px;
                        border:1px solid #c8d6c8;
